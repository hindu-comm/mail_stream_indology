...
title = "208 H.M.Hubey"
date = "1998-11-08"
upstream_url = "https://list.indology.info/pipermail/indology/1998-November/014043.html"

+++
[Archive link](https://list.indology.info/pipermail/indology/1998-November/014043.html)
...
Mark
-==-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
hubeyh at montclair.edu =-=-=-= http://www.csam.montclair.edu/+AH4-hubey
=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
