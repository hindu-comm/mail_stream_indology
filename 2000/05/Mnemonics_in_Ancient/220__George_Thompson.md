+++
title = "220 George Thompson"
date = "2000-05-23"
upstream_url = "https://list.indology.info/pipermail/indology/2000-May/021439.html"

+++
[Archive link](https://list.indology.info/pipermail/indology/2000-May/021439.html)
...
elaborate 'memory palaces,'  from mnemonics in ancient India, which appear to
...
A. Sandness] and Staal himself have mentioned yet another device: that of the
...
particular element in the transmitted text.  The obligation to observe sandhi
...
skill, as the memorization of a text 'backwards and forwards' would appear to
be.

This suggests that in Vedic there is in fact a kind of ekAgratA [to borrow
the term used by S.R. Mehta].  The vikRti, as a mnemonic device -- if that is
