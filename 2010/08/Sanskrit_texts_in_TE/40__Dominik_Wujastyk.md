...
date = "2010-08-27"
upstream_url = "https://list.indology.info/pipermail/indology/2010-August/034689.html"

+++
[Archive link](https://list.indology.info/pipermail/indology/2010-August/034689.html)

I am pleased to announce that the SARIT project is now releasing the
TEI<http://www.tei-c.org/index.xml>-encoded
...
XML<http://en.wikipedia.org/wiki/Xml>files and TEI-encoding, one way
to get started is to find an XML-aware editing
program <http://en.wikipedia.org/wiki/Xml_editor>.  There are many
available, some are free: there's a comparative table
here<http://en.wikipedia.org/wiki/List_of_XML_editors>.
The oXygen XML editor <http://en.wikipedia.org/wiki/Oxygen_XML_Editor> is
