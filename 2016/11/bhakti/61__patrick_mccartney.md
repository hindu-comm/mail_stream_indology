...
date = "2016-11-09"
upstream_url = "https://list.indology.info/pipermail/indology/2016-November/044554.html"

+++
[Archive link](https://list.indology.info/pipermail/indology/2016-November/044554.html)
...
>
> Perhaps it is relevant to stress that the occurrence of a word as a series
> of writing symbols in a text is one thing, and that the meaning of the word
> in a given context may differ from the one in another context. For instance,
>
...
>
> then you are starting from a particular concept that is labelled ‘bhakti’,
> and in that sense you are right. If, for instance, one soberly reads the
> Bhagavadgītā without later commentaries, one must conclude that later
> ‘bhakti’ is a far cry from the rather subdued theism in that text. The same
...
URL: <https://list.indology.info/pipermail/indology/attachments/20161109/c22e3dd2/attachment.htm>
