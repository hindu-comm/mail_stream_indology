+++
title = "23 Johnrobert Gardner"
date = "2022-08-04"
upstream_url = "https://list.indology.info/pipermail/indology/2022-August/056597.html"
+++
[Archive link](https://list.indology.info/pipermail/indology/2022-August/056597.html)

An example that always made sense to me, because it adds a phonetic instance of a rule I was taught that helped me very much with this concept “Sanskrit abhors a hiatus“: 

The way we pronounce “the” differently as in the animal vs the dog. To say the animal using the same pronunciation as we use with the dog provokes an awkward phonetic hiatus. This helped me into it what was going on with sandhi

JR Gardner, Ph.D., NREMT-P, I/C

> On Aug 4, 2022, at 17:26, Rein Ende via INDOLOGY <indology at list.indology.info> wrote:
> 
> 
> Sandhi in Sanskrit is an example of sound shifts at word boundaries.
> In English we have shifts such as the transformation into 'an orange' from 'a norange' from the original 'narañja' (Spanish from original Persian).
> Also 'an apron' from 'a napron' loaned from 'napperon' (napkin) (from French with an obviously related cognate).
> There is the example of the presumed 'Lady Mondegrain' from a hearing of a line in a poem mentioning a death, which reads "...laid him on the green..."
> 
> Rein Ende
> MA, McMaster University
> 
> 
>> On Thu, Aug 4, 2022 at 5:09 PM Matthew Kapstein via INDOLOGY <indology at list.indology.info> wrote:
...
>> 
>> Get Outlook for iOS
>> From: INDOLOGY <indology-bounces at list.indology.info> on behalf of Allen, Michael S (msa2b) via INDOLOGY <indology at list.indology.info>
...
URL: <https://list.indology.info/pipermail/indology/attachments/20220804/2800b506/attachment.htm>
