...
date = "2023-07-31"
upstream_url = "https://list.indology.info/pipermail/indology/2023-July/057976.html"
+++
[Archive link](https://list.indology.info/pipermail/indology/2023-July/057976.html)

Thank you, Christophe, as always, for the excellent new information.  I've
added the new entries.  They're not showing up: some glitch that I'll fix.
...
On Mon, 31 Jul 2023 at 03:53, Christophe Vielle via INDOLOGY <
indology at list.indology.info> wrote:

> It seems that the Lal Bahadur Shastri Sanskrit University (
> https://www.slbsrsv.ac.in/ ) mss. collection on Archiv was not mentioned
> (note that there are a few Oriya palm-leaf mss. there):
>
>
> https://archive.org/search?query=creator%3A%22Lal+Bahadur+Shastri+Sanskrit+University%22
>
> Also a mini-collection of (3) Sharada mss. provided by "Puneet Jyotishi
> Jammu"
>
>
> https://archive.org/search?query=creator%3A%22Received+Through+Puneet+Jyotishi+Jammu%22
>
> By the way, does the Sanskrit (paper - devanagari) mss. collection
> provided by "I am visionary Tunes", listed by Dominik, correspond to a
> private or institutional one (and which one in one or the other case)? See
>
> https://archive.org/search?query=creator%3A%22I_AM_VISIONARY_TUNES%22
>
> Bw
> Christophe
>
> Le 27 juil. 2023 à 22:53, Dominik Wujastyk via INDOLOGY <
> indology at list.indology.info> a écrit :
>
> PS,
> I put what I knew about this collection in 2018 into PanditProject:
>
>    - https://www.panditproject.org/entity/108617/collection
>
> Also, at least some of the indianmanuscripts.com manuscripts are now
> appearing through the NAMAMI database and being identified as located in
> the Jawaharlal Nehru Library in Kurukshetra.  E.g., compare these
>
>    - https://www.panditproject.org/entity/113349/manuscript
>    and
>    - https://www.panditproject.org/entity/113846/manuscript
>
>
> On Thu, 27 Jul 2023 at 14:00, Dominik Wujastyk <wujastyk at gmail.com> wrote:
>
>> It's hard to find out about this site.  But a few years ago, I wrote to
>> the person who seemed to be behind it in these terms:
>>
>> Dear Mr Madan Mohan Gupta,
>>
>> Yesterday, by chance, I discovered your website indianmanuscripts.com.
>> I am very impressed by what you have done at this website.  You have
>> provided many important manuscripts and books for scholarly study.  It is
>> such ancient works upon which scholarship depends.  These are the
>> life-blood of intellectual work about India.
>>
>> I want to thank you and your colleagues for making these wonderful
>> resources available to the public.
>>
>> I have made a link to your website from indology.info
>> <http://indology.info/links/img/>; I hope this is acceptable to you.  If
>> not, or if you would like the link differently expressed, please just let
>> me know.
>>
>> Sincerely,
>> Dominik Wujastyk
...
>> I received no reply.
>>
>> I've just re-added it to the current listing on the INDOLOGY website.
>>
>> Dominik
>>
>> On Wed, 26 Jul 2023 at 13:20, Davidson, Ronald M. <
>> RDavidson at fairfield.edu> wrote:
>>
>>> I appreciate everyone’s input on manuscript collections.
>>>
>>> Perhaps I overlooked it’s notice by others, but this rather
>>> idiosyncratic collection came to my attention some time ago:
...
>>> there in the listing at http: //indology. info/external-resources, afaik.
>>> The way information is presented is far from clear: I'm trying to get an
>>> upgrade to the Wordpress
>>>
>>> Thanks for this Tim.  Links to the resources you mention are already
>>> there in the listing at http://indology.info/external-resources<
...
>>> Greetings,
>>>    The  Lalcand Research Library (originally in Lāhore) of D.A.V.
>>> College, Chandigarh has a large collection, some of which was previously
...
>>> subscription.
>>>    One note about the Penn collection: it is integrated into the
>>> worldcat site, so a search for a book will also bring up notices of the
>>> Penn collection, plus links that bring you directly to the digitized images.
>>> Best wishes,
>>> Tim Cahill
>>>
>>>
...
>>> indology-owner at list.indology.info<mailto:
>>> indology-owner at list.indology.info>
>>>
...
>>> Endangered Archives programme of the British Library (https://eap.bl.uk/
>>> <
...
URL: <https://list.indology.info/pipermail/indology/attachments/20230731/00ababef/attachment.htm>
