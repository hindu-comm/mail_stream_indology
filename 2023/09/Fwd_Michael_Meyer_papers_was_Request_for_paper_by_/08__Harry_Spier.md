+++
title = "08 Harry Spier"
date = "2023-09-05"
upstream_url = "https://list.indology.info/pipermail/indology/2023-September/058136.html"
+++
[Archive link](https://list.indology.info/pipermail/indology/2023-September/058136.html)
...
dictionaries available online, all at once. You can input terms in the
International
Alphabet for Sanskrit Transliteration
<https://en.wikipedia.org/wiki/International_Alphabet_of_Sanskrit_Transliteration>
or in the Velthuis encoding scheme <https://en.wikipedia.org/wiki/Velthuis>.
See below for more details on input conventions.
...
to the second vowel—as in *praüga*—or insert a space character between the
two vowels—as in * pra uga*.
Cross-references
...
called ‘fuzzy matching.’ The metric used for comparing strings is the
Levenshtein
...
string. The query mandra~ <https://michaelmeyer.fr/sanskrit?q=mandra~>, for
instance, returns terms like *mandra*, *maṃdra*, *madra*, * mantra*, etc.
...
<https://michaelmeyer.fr/sanskrit?q=*uddyota~>, for instance, matches terms
that end with something close to *uddyota*, and returns, among else,
*uddyota*, * śāntyuddyota*, *ācāroddyota*, *udyota*, etc.
Credits

Most of the above dictionaries were prepared and encoded by Jim Funderburk,
Thomas Malten *et al.* at Cologne University
...
>>    - one sample syllabus for a Sanskrit language course at the beginning
...
>> Central Time/Midnight Eastern Time on October 12th 2023.* Candidates may
>> be asked to provide additional materials following the initial review.
>>
...
URL: <https://list.indology.info/pipermail/indology/attachments/20230905/4643995a/attachment.htm>
